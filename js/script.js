...
function frame() {
	...
	if(moveTheDots === false) {
		...
		for(var i = 0; i < xLocs.length; i++) {
			...
			//run check for left wall
						//Hit detection for ball circumference instead center
...
function addClick(x, y) {
	...
	//looping so speed can't equal 0 (fixes stuck dots)
...
//DELAYS "HOW MANY DOTS" MESSAGE/INPUT BOX
function setup(){
